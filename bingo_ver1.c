...
void ButtonDown(int face, int lednum)
{
    ...
    if (bingo_count < 3){
        ...
        if (is_end) {
            ...
            if (GetColor(face, 1).b == 255 && GetColor(face, 7).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 5).b == 255 && GetColor(face, 3).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 0).b == 255 && GetColor(face, 2).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 7).b == 255 && GetColor(face, 4).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 6).b == 255 && GetColor(face, 8).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 1).b == 255 && GetColor(face, 4).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 0).b == 255 && GetColor(face, 6).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 5).b == 255 && GetColor(face, 4).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 3).b == 255 && GetColor(face, 4).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 2).b == 255 && GetColor(face, 8).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 2).b == 255 && GetColor(face, 1).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 3).b == 255 && GetColor(face, 6).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 5).b == 255 && GetColor(face, 8).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 0).b == 255 && GetColor(face, 1).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 7).b == 255 && GetColor(face, 8).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 0).b == 255 && GetColor(face, 3).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            ...
            if (GetColor(face, 2).b == 255 && GetColor(face, 5).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
            if (GetColor(face, 6).b == 255 && GetColor(face, 7).b == 255){
                bingo_count++;
                newface = face;
                newlednum = lednum;
            }
